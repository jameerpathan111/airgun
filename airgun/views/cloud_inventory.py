...
class InventoryItemsView(Accordion):
    ...
    def expand(self, name):
        ...
        self.browser.click(self.ITEM.format(name), parent=self)
    ...
    def read(self):
        return {
            ...
            'status': self.status,
            'allow_auto_upload': self.parent.parent.auto_update.read(),
            'obfuscate_host_names': self.parent.parent.obfuscate_hostnames.read(),
